...
val http_config_term : Eio.Fs.dir_ty Eio.Path.t -> Fetch_cmdliner.config Cmdliner.Term.t
...
(** [with_client ~sw ~env ~fs ?http_config ?profile f] loads a session and creates a client,
