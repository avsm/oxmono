...
let input_jsont =
  ...
  |> Jsont.Object.mem "$type" Jsont.string ~dec_absent:(fun () -> "sh.tangled.repo.forkStatus#input") ~enc:(fun _ -> "sh.tangled.repo.forkStatus#input")
  |> Jsont.Object.mem "branch" Jsont.string ~enc:(fun r -> r.branch)
  |> Jsont.Object.mem "did" Jsont.string ~enc:(fun r -> r.did)
...
let output_jsont =
  ...
  |> Jsont.Object.mem "$type" Jsont.string ~dec_absent:(fun () -> "sh.tangled.repo.forkStatus#output") ~enc:(fun _ -> "sh.tangled.repo.forkStatus#output")
