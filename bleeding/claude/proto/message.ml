...
module User = struct
  ...
  (* Jsont codec for outgoing user messages - wraps in message envelope *)
  let outgoing_jsont : t Jsont.t =
    (* The inner message object with role and content *)
    let message_jsont =
      Jsont.Object.map ~kind:"UserOutgoingMessage" (fun _role json_content ->
          let content = decode_content json_content in
          { content; unknown = Unknown.empty })
      |> Jsont.Object.mem "role" Jsont.string ~enc:(fun _ -> "user")
      |> Jsont.Object.mem "content" Jsont.json ~enc:(fun t ->
          encode_content (content t))
      |> Jsont.Object.finish
    in
    Jsont.Object.map ~kind:"UserOutgoingEnvelope" Fun.id
    |> Jsont.Object.mem "message" message_jsont ~enc:Fun.id
    |> Jsont.Object.finish
end
...
module System = struct
  ...
  let init_jsont : init Jsont.t =
    ...
    |> Jsont.Object.keep_unknown Unknown.mems ~enc:(fun (r : init) -> r.unknown)
    |> Jsont.Object.finish
  ...
  let error_jsont : error Jsont.t =
    ...
    |> Jsont.Object.keep_unknown Unknown.mems ~enc:(fun (r : error) ->
        r.unknown)
    |> Jsont.Object.finish
