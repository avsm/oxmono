...
let encoded_userinfo__local = Uriz.userinfo__local

let encoded_host__local = Uriz.host__local

let encoded_query__local = Uriz.query__local

let encoded_fragment__local = Uriz.fragment__local

let encoded_path__local = Uriz.path__local
