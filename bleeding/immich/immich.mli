...
module User : sig
  ...
  val search_users : t -> unit -> ResponseDto.t list
...
module Partner : sig
  ...
  val get_partners : direction:string -> t -> unit -> ResponseDto.t list
...
module TimeBuckets : sig
  ...
  *)
  val get_time_buckets : ?album_id:string -> ?is_favorite:string -> ?is_trashed:string -> ?key:string -> ?order:string -> ?person_id:string -> ?slug:string -> ?tag_id:string -> ?user_id:string -> ?visibility:string -> ?with_coordinates:string -> ?with_partners:string -> ?with_stacked:string -> t -> unit -> ResponseDto.t list
end
...
module Tag : sig
  module UpdateDto : sig
    ...
    (** Construct a value *)
    val v : ?color:string option -> unit -> t

    val color : t -> string option option
  ...
  module CreateDto : sig
    ...
    (** Construct a value *)
    val v : name:string -> ?color:string -> ?parent_id:string option -> unit -> t

    val color : t -> string option

    val name : t -> string

    val parent_id : t -> string option option
  ...
  val get_all_tags : t -> unit -> ResponseDto.t list
  ...
  val upsert_tags : body:TagUpsert.Dto.t -> t -> unit -> ResponseDto.t list
...
module SyncAck : sig
  ...
  val get_sync_ack : t -> unit -> Dto.t list
end
...
module SharedLinkEdit : sig
  module Dto : sig
    ...
    *)
    val v : ?allow_download:bool -> ?allow_upload:bool -> ?change_expiry_time:bool -> ?description:string option -> ?expires_at:Ptime.t option -> ?password:string option -> ?show_metadata:bool -> ?slug:string option -> unit -> t
    ...
    val expires_at : t -> Ptime.t option option

    val password : t -> string option option

    val show_metadata : t -> bool option

    val slug : t -> string option option
...
module Session : sig
  ...
  val get_user_sessions_admin : id:string -> t -> unit -> ResponseDto.t list

  (** Retrieve sessions

      Retrieve a list of sessions for the user. *)
  val get_sessions : t -> unit -> ResponseDto.t list
...
module ServerVersionHistory : sig
  ...
  val get_version_history : t -> unit -> ResponseDto.t list
end
...
module Activity : sig
  module ResponseDto : sig
    ...
    (** Construct a value *)
    val v : created_at:Ptime.t -> id:string -> type_:Reaction.Type.t -> user:User.ResponseDto.t -> ?asset_id:string -> ?comment:string option -> unit -> t

    val asset_id : t -> string option

    val comment : t -> string option option
  ...
  val get_activities : album_id:string -> ?asset_id:string -> ?level:string -> ?type_:string -> ?user_id:string -> t -> unit -> ResponseDto.t list
...
module Queue : sig
  ...
  val get_queues : t -> unit -> ResponseDto.t list
...
module PluginTrigger : sig
  ...
  val get_plugin_triggers : t -> unit -> ResponseDto.t list
end
...
module Workflow : sig
  ...
  val get_workflows : t -> unit -> ResponseDto.t list
...
module Plugin : sig
  ...
  val get_plugins : t -> unit -> ResponseDto.t list
...
module Places : sig
  ...
  val search_places : name:string -> t -> unit -> ResponseDto.t list
end
...
module Apikey : sig
  ...
  val get_api_keys : t -> unit -> ResponseDto.t list
...
module PeopleUpdate : sig
  module Item : sig
    ...
    *)
    val v : id:string -> ?birth_date:string option -> ?color:string option -> ?feature_face_asset_id:string -> ?is_favorite:bool -> ?is_hidden:bool -> ?name:string -> unit -> t

    (** Person date of birth.
    Note: the mobile app cannot currently set the birth date to null. *)
    val birth_date : t -> string option option
...
module NotificationUpdateAll : sig
  module Dto : sig
    ...
    (** Construct a value *)
    val v : ids:string list -> ?read_at:Ptime.t option -> unit -> t

    val ids : t -> string list

    val read_at : t -> Ptime.t option option
...
module Notification : sig
  module UpdateDto : sig
    ...
    (** Construct a value *)
    val v : ?read_at:Ptime.t option -> unit -> t
  ...
  module CreateDto : sig
    ...
    (** Construct a value *)
    val v : title:string -> user_id:string -> ?data:Jsont.json -> ?description:string option -> ?level:NotificationLevel.T.t -> ?read_at:Ptime.t option -> ?type_:Type.t -> unit -> t
  ...
  val get_notifications : ?id:string -> ?level:string -> ?type_:string -> ?unread:string -> t -> unit -> Dto.t list
...
module MapReverseGeocode : sig
  ...
  val reverse_geocode : lat:string -> lon:string -> t -> unit -> ResponseDto.t list
end
...
module MapMarker : sig
  ...
  val get_map_markers : ?file_created_after:string -> ?file_created_before:string -> ?is_archived:string -> ?is_favorite:string -> ?with_partners:string -> ?with_shared_albums:string -> t -> unit -> ResponseDto.t list
end
...
module QueueJob : sig
  ...
  val get_queue_jobs : name:string -> ?status:string -> t -> unit -> ResponseDto.t list
end
...
module Exif : sig
  module ResponseDto : sig
    ...
    val city : t -> string option option

    val country : t -> string option option

    val date_time_original : t -> Ptime.t option option

    val description : t -> string option option

    val exif_image_height : t -> float option option

    val exif_image_width : t -> float option option

    val exposure_time : t -> string option option

    val f_number : t -> float option option

    val file_size_in_byte : t -> int64 option option

    val focal_length : t -> float option option

    val iso : t -> float option option

    val latitude : t -> float option option

    val lens_model : t -> string option option

    val longitude : t -> float option option

    val make : t -> string option option

    val model : t -> string option option

    val modify_date : t -> Ptime.t option option

    val orientation : t -> string option option

    val projection_type : t -> string option option

    val rating : t -> float option option

    val state : t -> string option option

    val time_zone : t -> string option option
...
module CreateProfileImage : sig
  ...
  val create_profile_image : body:Fetch.Form.part list -> t -> unit -> ResponseDto.t
end
...
module Library : sig
  ...
  val get_all_libraries : t -> unit -> ResponseDto.t list
...
module UserAdmin : sig
  module UpdateDto : sig
    ...
    (** Construct a value *)
    val v : ?avatar_color:UserAvatarColor.T.t -> ?email:string -> ?is_admin:bool -> ?name:string -> ?password:string -> ?pin_code:string option -> ?quota_size_in_bytes:int64 option -> ?should_change_password:bool -> ?storage_label:string option -> unit -> t
    ...
    val pin_code : t -> string option option

    val quota_size_in_bytes : t -> int64 option option

    val should_change_password : t -> bool option

    val storage_label : t -> string option option
  ...
  module CreateDto : sig
    ...
    (** Construct a value *)
    val v : email:string -> name:string -> password:string -> ?avatar_color:UserAvatarColor.T.t -> ?is_admin:bool -> ?notify:bool -> ?quota_size_in_bytes:int64 option -> ?should_change_password:bool -> ?storage_label:string option -> unit -> t
  ...
  (** Search users
      ...
      Search for users. *)
  val search_users_admin : ?id:string -> ?with_deleted:string -> t -> unit -> ResponseDto.t list
  ...
  (** Delete a user
      ...
      Delete a user. *)
  val delete_user_admin : id:string -> body:UserAdminDelete.Dto.t -> t -> unit -> ResponseDto.t
...
module UpdateAsset : sig
  module Dto : sig
    ...
    (** Construct a value *)
    val v : ?date_time_original:string -> ?description:string -> ?is_favorite:bool -> ?latitude:float -> ?live_photo_video_id:string option -> ?longitude:float -> ?rating:float -> ?visibility:AssetVisibility.T.t -> unit -> t
    ...
    val live_photo_video_id : t -> string option option
...
module TimeBucketAsset : sig
  module ResponseDto : sig
    ...
    *)
    val v : city:string option list -> country:string option list -> duration:string option list -> file_created_at:string list -> id:string list -> is_favorite:bool list -> is_image:bool list -> is_trashed:bool list -> live_photo_video_id:string option list -> local_offset_hours:float list -> owner_id:string list -> projection_type:string option list -> ratio:float list -> thumbhash:string option list -> visibility:AssetVisibility.T.t list -> ?latitude:float option list -> ?longitude:float option list -> ?stack:string list option list -> unit -> t

    (** Array of city names extracted from EXIF GPS data *)
    val city : t -> string option list

    (** Array of country names extracted from EXIF GPS data *)
    val country : t -> string option list

    (** Array of video durations in HH:MM:SS format (null for images) *)
    val duration : t -> string option list
    ...
    val latitude : t -> float option list option

    (** Array of live photo video asset IDs (null for non-live photos) *)
    val live_photo_video_id : t -> string option list

    (** Array of UTC offset hours at the time each photo was taken. Positive values are east of UTC, negative values are west of UTC. Values may be fractional (e.g., 5.5 for +05:30, -9.75 for -09:45). Applying this offset to 'fileCreatedAt' will give you the time the photo was taken from the photographer's perspective. *)
    val local_offset_hours : t -> float list

    (** Array of longitude coordinates extracted from EXIF GPS data *)
    val longitude : t -> float option list option

    (** Array of owner IDs for each asset *)
    val owner_id : t -> string list

    (** Array of projection types for 360° content (e.g., "EQUIRECTANGULAR", "CUBEFACE", "CYLINDRICAL") *)
    val projection_type : t -> string option list

    (** Array of aspect ratios (width/height) for each asset *)
    val ratio : t -> float list

    (** Array of stack information as [stackId, assetCount] tuples (null for non-stacked assets) *)
    val stack : t -> string list option list option

    (** Array of BlurHash strings for generating asset previews (base64 encoded) *)
    val thumbhash : t -> string option list
...
module AssetBulk : sig
  module UpdateDto : sig
    ...
    (** Construct a value *)
    val v : ids:string list -> ?date_time_original:string -> ?date_time_relative:float -> ?description:string -> ?duplicate_id:string option -> ?is_favorite:bool -> ?latitude:float -> ?longitude:float -> ?rating:float -> ?time_zone:string -> ?visibility:AssetVisibility.T.t -> unit -> t
    ...
    val duplicate_id : t -> string option option
...
module StatisticsSearch : sig
  module Dto : sig
    ...
    (** Construct a value *)
    val v : ?album_ids:string list -> ?city:string option -> ?country:string option -> ?created_after:Ptime.t -> ?created_before:Ptime.t -> ?description:string -> ?device_id:string -> ?is_encoded:bool -> ?is_favorite:bool -> ?is_motion:bool -> ?is_not_in_album:bool -> ?is_offline:bool -> ?lens_model:string option -> ?library_id:string option -> ?make:string -> ?model:string option -> ?ocr:string -> ?person_ids:string list -> ?rating:float -> ?state:string option -> ?tag_ids:string list option -> ?taken_after:Ptime.t -> ?taken_before:Ptime.t -> ?trashed_after:Ptime.t -> ?trashed_before:Ptime.t -> ?type_:AssetTypeEnum.T.t -> ?updated_after:Ptime.t -> ?updated_before:Ptime.t -> ?visibility:AssetVisibility.T.t -> unit -> t
    ...
    val library_id : t -> string option option
    ...
    val tag_ids : t -> string list option option
...
module SmartSearch : sig
  module Dto : sig
    ...
    (** Construct a value *)
    val v : ?album_ids:string list -> ?city:string option -> ?country:string option -> ?created_after:Ptime.t -> ?created_before:Ptime.t -> ?device_id:string -> ?is_encoded:bool -> ?is_favorite:bool -> ?is_motion:bool -> ?is_not_in_album:bool -> ?is_offline:bool -> ?language:string -> ?lens_model:string option -> ?library_id:string option -> ?make:string -> ?model:string option -> ?ocr:string -> ?page:float -> ?person_ids:string list -> ?query:string -> ?query_asset_id:string -> ?rating:float -> ?size:float -> ?state:string option -> ?tag_ids:string list option -> ?taken_after:Ptime.t -> ?taken_before:Ptime.t -> ?trashed_after:Ptime.t -> ?trashed_before:Ptime.t -> ?type_:AssetTypeEnum.T.t -> ?updated_after:Ptime.t -> ?updated_before:Ptime.t -> ?visibility:AssetVisibility.T.t -> ?with_deleted:bool -> ?with_exif:bool -> unit -> t
...
module RandomSearch : sig
  module Dto : sig
    ...
    (** Construct a value *)
    val v : ?album_ids:string list -> ?city:string option -> ?country:string option -> ?created_after:Ptime.t -> ?created_before:Ptime.t -> ?device_id:string -> ?is_encoded:bool -> ?is_favorite:bool -> ?is_motion:bool -> ?is_not_in_album:bool -> ?is_offline:bool -> ?lens_model:string option -> ?library_id:string option -> ?make:string -> ?model:string option -> ?ocr:string -> ?person_ids:string list -> ?rating:float -> ?size:float -> ?state:string option -> ?tag_ids:string list option -> ?taken_after:Ptime.t -> ?taken_before:Ptime.t -> ?trashed_after:Ptime.t -> ?trashed_before:Ptime.t -> ?type_:AssetTypeEnum.T.t -> ?updated_after:Ptime.t -> ?updated_before:Ptime.t -> ?visibility:AssetVisibility.T.t -> ?with_deleted:bool -> ?with_exif:bool -> ?with_people:bool -> ?with_stacked:bool -> unit -> t
...
module MetadataSearch : sig
  module Dto : sig
    ...
    (** Construct a value *)
    val v : ?album_ids:string list -> ?checksum:string -> ?city:string option -> ?country:string option -> ?created_after:Ptime.t -> ?created_before:Ptime.t -> ?description:string -> ?device_asset_id:string -> ?device_id:string -> ?encoded_video_path:string -> ?id:string -> ?is_encoded:bool -> ?is_favorite:bool -> ?is_motion:bool -> ?is_not_in_album:bool -> ?is_offline:bool -> ?lens_model:string option -> ?library_id:string option -> ?make:string -> ?model:string option -> ?ocr:string -> ?order:AssetOrder.T.t -> ?original_file_name:string -> ?original_path:string -> ?page:float -> ?person_ids:string list -> ?preview_path:string -> ?rating:float -> ?size:float -> ?state:string option -> ?tag_ids:string list option -> ?taken_after:Ptime.t -> ?taken_before:Ptime.t -> ?thumbnail_path:string -> ?trashed_after:Ptime.t -> ?trashed_before:Ptime.t -> ?type_:AssetTypeEnum.T.t -> ?updated_after:Ptime.t -> ?updated_before:Ptime.t -> ?visibility:AssetVisibility.T.t -> ?with_deleted:bool -> ?with_exif:bool -> ?with_people:bool -> ?with_stacked:bool -> unit -> t
...
module AssetOcr : sig
  ...
  val get_asset_ocr : id:string -> t -> unit -> ResponseDto.t list
end
...
module AssetMetadata : sig
  ...
  val get_asset_metadata : id:string -> t -> unit -> ResponseDto.t list

  (** Update asset metadata

      Update or add metadata key-value pairs for the specified asset. *)
  val update_asset_metadata : id:string -> body:AssetMetadataUpsert.Dto.t -> t -> unit -> ResponseDto.t list
...
module AssetMedia : sig
  ...
  *)
  val upload_asset : ?key:string -> ?slug:string -> ?x_immich_checksum:string -> body:Fetch.Form.part list -> t -> unit -> ResponseDto.t

  (** Replace asset

      Replace the asset with new file, without changing its id. *)
  val replace_asset : id:string -> ?key:string -> ?slug:string -> body:Fetch.Form.part list -> t -> unit -> ResponseDto.t
end
...
module AssetMetadataBulk : sig
  ...
  val update_bulk_asset_metadata : body:AssetMetadataBulkUpsert.Dto.t -> t -> unit -> ResponseDto.t list
end
...
module AssetIds : sig
  ...
  val add_shared_link_assets : id:string -> ?key:string -> ?slug:string -> body:Dto.t -> t -> unit -> ResponseDto.t list
  ...
  val remove_shared_link_assets : id:string -> ?key:string -> ?slug:string -> body:Dto.t -> t -> unit -> ResponseDto.t list
end
...
module Asset : sig
  ...
  val get_random : ?count:string -> t -> unit -> ResponseDto.t list
...
module Stack : sig
  ...
  val search_stacks : ?primary_asset_id:string -> t -> unit -> ResponseDto.t list
...
module SearchExplore : sig
  ...
  val get_explore_data : t -> unit -> ResponseDto.t list
end
...
module Memory : sig
  ...
  (** Retrieve memories
      ...
      @param size Number of memories to return
  *)
  val search_memories : ?for_:string -> ?is_saved:string -> ?is_trashed:string -> ?order:string -> ?size:string -> ?type_:string -> t -> unit -> ResponseDto.t list
...
module Duplicate : sig
  ...
  val get_asset_duplicates : t -> unit -> ResponseDto.t list
end
...
module AlbumUserAdd : sig
  module Dto : sig
    ...
    val role : t -> AlbumUserRole.T.t option
...
module Album : sig
  ...
  *)
  val get_all_albums : ?asset_id:string -> ?shared:string -> t -> unit -> ResponseDto.t list
...
module SharedLink : sig
  ...
  module ResponseDto : sig
    ...
    (** Construct a value *)
    val v : allow_download:bool -> allow_upload:bool -> assets:Asset.ResponseDto.t list -> created_at:Ptime.t -> id:string -> key:string -> show_metadata:bool -> type_:Type.t -> user_id:string -> ?album:Album.ResponseDto.t -> ?description:string -> ?expires_at:Ptime.t -> ?password:string -> ?slug:string -> ?token:string option -> unit -> t
    ...
    val token : t -> string option option
  ...
  module CreateDto : sig
    ...
    (** Construct a value *)
    val v : type_:Type.t -> ?allow_download:bool -> ?show_metadata:bool -> ?album_id:string -> ?allow_upload:bool -> ?asset_ids:string list -> ?description:string option -> ?expires_at:Ptime.t option -> ?password:string option -> ?slug:string option -> unit -> t
  ...
  val get_all_shared_links : ?album_id:string -> ?id:string -> t -> unit -> ResponseDto.t list
...
module Person : sig
  module UpdateDto : sig
    ...
    Note: the mobile app cannot currently set the birth date to null.
        ...
        @param name Person name.
    *)
    val v : ?birth_date:string option -> ?color:string option -> ?feature_face_asset_id:string -> ?is_favorite:bool -> ?is_hidden:bool -> ?name:string -> unit -> t
  ...
  module CreateDto : sig
    ...
    Note: the mobile app cannot currently set the birth date to null.
        ...
        @param name Person name.
    *)
    val v : ?birth_date:string option -> ?color:string option -> ?is_favorite:bool -> ?is_hidden:bool -> ?name:string -> unit -> t
  ...
  val reassign_faces : id:string -> body:Jsont.json -> t -> unit -> ResponseDto.t list

  (** Search people

      Search for people by name. *)
  val search_person : name:string -> ?with_hidden:string -> t -> unit -> ResponseDto.t list
end
...
module BulkId : sig
  ...
  val add_assets_to_album : id:string -> ?key:string -> ?slug:string -> body:BulkIds.Dto.t -> t -> unit -> ResponseDto.t list

  (** Remove assets from an album

      Remove multiple assets from a specific album by its ID. *)
  val remove_asset_from_album : id:string -> body:BulkIds.Dto.t -> t -> unit -> ResponseDto.t list

  (** Add assets to a memory

      Add a list of asset IDs to a specific memory. *)
  val add_memory_assets : id:string -> body:BulkIds.Dto.t -> t -> unit -> ResponseDto.t list

  (** Remove assets from a memory

      Remove a list of asset IDs from a specific memory. *)
  val remove_memory_assets : id:string -> body:BulkIds.Dto.t -> t -> unit -> ResponseDto.t list

  (** Update people

      Bulk update multiple people at once. *)
  val update_people : body:People.UpdateDto.t -> t -> unit -> ResponseDto.t list

  (** Merge people

      Merge a list of people into the person specified in the path parameter. *)
  val merge_person : id:string -> body:MergePerson.Dto.t -> t -> unit -> ResponseDto.t list

  (** Tag assets

      Add a tag to all the specified assets. *)
  val tag_assets : id:string -> body:BulkIds.Dto.t -> t -> unit -> ResponseDto.t list

  (** Untag assets

      Remove a tag from all the specified assets. *)
  val untag_assets : id:string -> body:BulkIds.Dto.t -> t -> unit -> ResponseDto.t list
end
...
module AssetFace : sig
  ...
  val get_faces : id:string -> t -> unit -> ResponseDto.t list
end
...
module Client : sig
  ...
  val delete_activity : id:string -> t -> unit -> unit

  (** Unlink all OAuth accounts

      Unlinks all OAuth accounts associated with user accounts in the system. *)
  val unlink_all_oauth_accounts_admin : t -> unit -> unit

  (** Delete database backup

      Delete a backup by its filename *)
  val delete_database_backup : body:DatabaseBackupDelete.Dto.t -> t -> unit -> unit

  (** Start database backup restore flow

      Put Immich into maintenance mode to restore a backup (Immich must not be configured) *)
  val start_database_restore_flow : t -> unit -> unit

  (** Upload database backup

      Uploads .sql/.sql.gz file to restore backup from *)
  val upload_database_backup : body:Fetch.Form.part list -> t -> unit -> unit

  (** Download database backup

      Downloads the database backup file *)
  val download_database_backup : filename:string -> t -> unit -> string

  (** Set maintenance mode

      Put Immich into or take it out of maintenance mode *)
  val set_maintenance_mode : body:SetMaintenanceMode.Dto.t -> t -> unit -> unit
  ...
  val delete_album : id:string -> t -> unit -> unit

  (** Update user role

      Change the role for a specific user in a specific album. *)
  val update_album_user : id:string -> user_id:string -> body:UpdateAlbumUser.Dto.t -> t -> unit -> unit

  (** Remove user from album

      Remove a user from an album. Use an ID of "me" to leave a shared album. *)
  val remove_user_from_album : id:string -> user_id:string -> t -> unit -> unit

  (** Delete an API key

      Deletes an API key identified by its ID. The current user must own this API key. *)
  val delete_api_key : id:string -> t -> unit -> unit

  (** Update assets

      Updates multiple assets at the same time. *)
  val update_assets : body:AssetBulk.UpdateDto.t -> t -> unit -> unit

  (** Delete assets

      Deletes multiple assets at the same time. *)
  val delete_assets : body:AssetBulkDelete.Dto.t -> t -> unit -> unit

  (** Copy asset

      Copy asset information like albums, tags, etc. from one asset to another. *)
  val copy_asset : body:AssetCopy.Dto.t -> t -> unit -> unit

  (** Retrieve assets by device ID

      Get all asset of a device that are in the database, ID only. *)
  val get_all_user_assets_by_device_id : device_id:string -> t -> unit -> string list

  (** Run an asset job

      Run a specific job on a set of assets. *)
  val run_asset_jobs : body:AssetJobs.Dto.t -> t -> unit -> unit

  (** Delete asset metadata

      Delete metadata key-value pairs for multiple assets. *)
  val delete_bulk_asset_metadata : body:AssetMetadataBulkDelete.Dto.t -> t -> unit -> unit

  (** Remove edits from an existing asset

      Removes all edit actions (crop, rotate, mirror) associated with the specified asset. *)
  val remove_asset_edits : id:string -> t -> unit -> unit

  (** Delete asset metadata by key

      Delete a specific metadata key-value pair associated with the specified asset. *)
  val delete_asset_metadata : id:string -> key:string -> t -> unit -> unit

  (** Download original asset

      Downloads the original file of the specified asset. *)
  val download_asset : id:string -> ?edited:string -> ?key:string -> ?slug:string -> t -> unit -> string
  ...
  val view_asset : id:string -> ?edited:string -> ?key:string -> ?size:string -> ?slug:string -> t -> unit -> string

  (** Play asset video

      Streams the video file for the specified asset. This endpoint also supports byte range requests. *)
  val play_asset_video : id:string -> ?key:string -> ?slug:string -> t -> unit -> string

  (** Setup pin code

      Setup a new pin code for the current user. *)
  val setup_pin_code : body:PinCodeSetup.Dto.t -> t -> unit -> unit

  (** Change pin code

      Change the pin code for the current user. *)
  val change_pin_code : body:PinCodeChange.Dto.t -> t -> unit -> unit

  (** Reset pin code

      Reset the pin code for the current user by providing the account password *)
  val reset_pin_code : body:PinCodeReset.Dto.t -> t -> unit -> unit

  (** Lock auth session

      Remove elevated access to locked assets from the current session. *)
  val lock_auth_session : t -> unit -> unit

  (** Unlock auth session

      Temporarily grant the session elevated access to locked assets by providing the correct PIN code. *)
  val unlock_auth_session : body:SessionUnlock.Dto.t -> t -> unit -> unit
  ...
  val download_archive : ?key:string -> ?slug:string -> body:AssetIds.Dto.t -> t -> unit -> string

  (** Delete duplicates

      Delete multiple duplicate assets specified by their IDs. *)
  val delete_duplicates : body:BulkIds.Dto.t -> t -> unit -> unit

  (** Delete a duplicate

      Delete a single duplicate asset specified by its ID. *)
  val delete_duplicate : id:string -> t -> unit -> unit
  ...
  val create_face : body:AssetFace.CreateDto.t -> t -> unit -> unit

  (** Delete a face

      Delete a face identified by the id. Optionally can be force deleted. *)
  val delete_face : id:string -> body:AssetFaceDelete.Dto.t -> t -> unit -> unit
  ...
  val create_job : body:Job.CreateDto.t -> t -> unit -> unit

  (** Delete a library

      Delete an external library by its ID. *)
  val delete_library : id:string -> t -> unit -> unit

  (** Scan a library

      Queue a scan for the external library to find and import new assets. *)
  val scan_library : id:string -> t -> unit -> unit

  (** Delete a memory

      Delete a specific memory by its ID. *)
  val delete_memory : id:string -> t -> unit -> unit

  (** Update notifications

      Update a list of notifications. Allows to bulk-set the read status of notifications. *)
  val update_notifications : body:NotificationUpdateAll.Dto.t -> t -> unit -> unit

  (** Delete notifications

      Delete a list of notifications at once. *)
  val delete_notifications : body:NotificationDeleteAll.Dto.t -> t -> unit -> unit

  (** Delete a notification

      Delete a specific notification. *)
  val delete_notification : id:string -> t -> unit -> unit

  (** Redirect OAuth to mobile

      Requests to this URL are automatically forwarded to the mobile app, and is used in some cases for OAuth redirecting. *)
  val redirect_oauth_to_mobile : t -> unit -> unit

  (** Remove a partner

      Stop sharing assets with a partner. *)
  val remove_partner : id:string -> t -> unit -> unit

  (** Delete people

      Bulk delete a list of people at once. *)
  val delete_people : body:BulkIds.Dto.t -> t -> unit -> unit

  (** Delete person

      Delete an individual person. *)
  val delete_person : id:string -> t -> unit -> unit

  (** Get person thumbnail

      Retrieve the thumbnail file for a person. *)
  val get_person_thumbnail : id:string -> t -> unit -> string

  (** Empty a queue

      Removes all jobs from the specified queue. *)
  val empty_queue : name:string -> body:QueueDelete.Dto.t -> t -> unit -> unit

  (** Retrieve search suggestions

      Retrieve search suggestions based on partial input. This endpoint is used for typeahead search features. *)
  val get_search_suggestions : ?country:string -> ?include_null:string -> ?lens_model:string -> ?make:string -> ?model:string -> ?state:string -> type_:string -> t -> unit -> string list

  (** Delete server product key

      Delete the currently set server product key. *)
  val delete_server_license : t -> unit -> unit

  (** Delete all sessions

      Delete all sessions for the user. This will not delete the current session. *)
  val delete_all_sessions : t -> unit -> unit

  (** Delete a session

      Delete a specific session by id. *)
  val delete_session : id:string -> t -> unit -> unit

  (** Lock a session

      Lock a specific session by id. *)
  val lock_session : id:string -> t -> unit -> unit

  (** Delete a shared link

      Delete a specific shared link by its ID. *)
  val remove_shared_link : id:string -> t -> unit -> unit

  (** Delete stacks

      Delete multiple stacks by providing a list of stack IDs. *)
  val delete_stacks : body:BulkIds.Dto.t -> t -> unit -> unit

  (** Delete a stack

      Delete a specific stack by its ID. *)
  val delete_stack : id:string -> t -> unit -> unit

  (** Remove an asset from a stack

      Remove a specific asset from a stack by providing the stack ID and asset ID. *)
  val remove_asset_from_stack : asset_id:string -> id:string -> t -> unit -> unit

  (** Acknowledge changes

      Send a list of synchronization acknowledgements to confirm that the latest changes have been received. *)
  val send_sync_ack : body:SyncAckSet.Dto.t -> t -> unit -> unit

  (** Delete acknowledgements

      Delete specific synchronization acknowledgments. *)
  val delete_sync_ack : body:SyncAckDelete.Dto.t -> t -> unit -> unit
  ...
  val get_sync_stream : body:SyncStream.Dto.t -> t -> unit -> unit

  (** Update admin onboarding

      Update the admin onboarding status. *)
  val update_admin_onboarding : body:AdminOnboarding.UpdateDto.t -> t -> unit -> unit

  (** Delete a tag

      Delete a specific tag by its ID. *)
  val delete_tag : id:string -> t -> unit -> unit

  (** Delete user product key

      Delete the registered product key for the current user. *)
  val delete_user_license : t -> unit -> unit

  (** Delete user onboarding

      Delete the onboarding status of the current user. *)
  val delete_user_onboarding : t -> unit -> unit

  (** Delete user profile image

      Delete the profile image of the current user. *)
  val delete_profile_image : t -> unit -> unit

  (** Retrieve user profile image

      Retrieve the profile image file for a user. *)
  val get_profile_image : id:string -> t -> unit -> string

  (** Retrieve unique paths

      Retrieve a list of unique folder paths from asset original paths. *)
  val get_unique_original_paths : t -> unit -> string list

  (** Delete a workflow

      Delete a workflow by its ID. *)
  val delete_workflow : id:string -> t -> unit -> unit
end
