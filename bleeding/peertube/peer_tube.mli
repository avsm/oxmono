...
module VideoUpload : sig
  ...
  val import_video : ?body:Fetch.Form.part list -> t -> unit -> Response.t

  (** Create a live *)
  val add_live : ?body:Fetch.Form.part list -> t -> unit -> Response.t

  (** Upload a video

      Uses a single request to upload a video. *)
  val upload_legacy : ?body:Fetch.Form.part list -> t -> unit -> Response.t
  ...
  *)
  val upload_resumable : upload_id:string -> content_range:string -> content_length:string -> ?body:Fetch.body -> t -> unit -> Response.t
end
...
module VideoToken : sig
  ...
  *)
  val request_video_token : id:string -> ?x_peertube_video_password:string -> t -> unit -> Response.t
end
...
module VideoStatsUserAgent : sig
  ...
  *)
  val get_api_v1_videos_by_id_stats_user_agent : id:string -> ?start_date:string -> ?end_date:string -> t -> unit -> T.t
end
...
module VideoStatsTimeserie : sig
  ...
  (** Get timeserie stats of a video
      ...
      @param end_date Filter stats by end date
  *)
  val get_api_v1_videos_by_id_stats_timeseries_by_metric : id:string -> metric:string -> ?start_date:string -> ?end_date:string -> t -> unit -> T.t
end
...
module VideoStatsRetention : sig
  ...
  (** Get retention stats of a video
      @param id The object id, uuid or short uuid
  *)
  val get_api_v1_videos_by_id_stats_retention : id:string -> t -> unit -> T.t
end
...
module VideoStatsOverall : sig
  ...
  (** Get overall stats of a video
      ...
      @param end_date Filter stats by end date
  *)
  val get_api_v1_videos_by_id_stats_overall : id:string -> ?start_date:string -> ?end_date:string -> t -> unit -> T.t
end
...
module VideoChapters : sig
  ...
  (** Get chapters of a video
      ...
      **PeerTube >= 6.0**
      ...
      @param x_peertube_video_password Required on password protected video
  *)
  val get_video_chapters : id:string -> ?x_peertube_video_password:string -> t -> unit -> T.t
end
...
module LiveVideoSession : sig
  module Response : sig
    ...
    *)
    val v : ?end_date:Ptime.t option -> ?error:int option -> ?id:int -> ?replay_video:Jsont.json -> ?start_date:Ptime.t -> unit -> t

    (** End date of the live session *)
    val end_date : t -> Ptime.t option option
  ...
  (** Get live session of a replay
      ...
      @param x_peertube_video_password Required on password protected video
  *)
  val get_api_v1_videos_by_id_live_session : id:string -> ?x_peertube_video_password:string -> t -> unit -> Response.t
end
...
module RunnerJob : sig
  ...
  module T : sig
    ...
    *)
    val v : ?created_at:Ptime.t -> ?error:string option -> ?failures:int -> ?finished_at:Ptime.t -> ?parent:Jsont.json option -> ?payload:RunnerJobPayload.T.t -> ?priority:int -> ?progress:int -> ?runner:Jsont.json option -> ?started_at:Ptime.t -> ?state:RunnerJobStateConstant.T.t -> ?type_:Type.t -> ?updated_at:Ptime.t -> ?uuid:Uuidv4.T.t -> unit -> t

    val created_at : t -> Ptime.t option

    (** Error message if the job is errored *)
    val error : t -> string option option
    ...
    val parent : t -> Jsont.json option option
    ...
    val runner : t -> Jsont.json option option
...
module RunnerJobAdmin : sig
  module T : sig
    ...
    (** Construct a value
        ...
        @param runner If job is associated to a runner
    *)
    val v : ?created_at:Ptime.t -> ?error:string option -> ?failures:int -> ?finished_at:Ptime.t -> ?parent:Jsont.json option -> ?payload:RunnerJobPayload.T.t -> ?priority:int -> ?progress:int -> ?runner:Jsont.json option -> ?started_at:Ptime.t -> ?state:RunnerJobStateConstant.T.t -> ?type_:RunnerJob.Type.t -> ?updated_at:Ptime.t -> ?uuid:Uuidv4.T.t -> ?private_payload:Jsont.json -> unit -> t
...
module RequestTwoFactor : sig
  ...
  (** Request two factor auth
      ...
      @param id Entity id
  *)
  val request_two_factor : id:string -> ?body:Jsont.json -> t -> unit -> Response.t list
end
...
module UpdateUser : sig
  module T : sig
    ...
    *)
    val v : ?admin_flags:UserAdminFlags.T.t -> ?email:Jsont.json -> ?email_verified:bool -> ?password:Password.T.t -> ?plugin_auth:string option -> ?role:UserRole.T.t -> ?video_quota:int -> ?video_quota_daily:int -> unit -> t
    ...
    val plugin_auth : t -> string option option
...
module UserRegistration : sig
  ...
  module T : sig
    ...
    *)
    val v : ?account_display_name:string -> ?channel_display_name:string -> ?channel_handle:string -> ?created_at:Ptime.t -> ?email:string -> ?email_verified:bool -> ?id:Id.T.t -> ?moderation_response:string option -> ?registration_reason:string -> ?state:Jsont.json -> ?updated_at:Ptime.t -> ?user:Jsont.json option -> ?username:string -> unit -> t
    ...
    val moderation_response : t -> string option option
    ...
    val user : t -> Jsont.json option option
...
module GetMeVideoRating : sig
  ...
  *)
  val get_api_v1_users_me_videos_by_video_id_rating : video_id:string -> t -> unit -> T.t
end
...
module VideoRedundancy : sig
  ...
  *)
  val get_mirrored_videos : target:string -> ?start:string -> ?count:string -> ?sort:string -> t -> unit -> T.t list
end
...
module CommentAutoTagPolicies : sig
  ...
  *)
  val get_api_v1_automatic_tags_policies_accounts_by_account_name_comments : account_name:string -> t -> unit -> T.t
end
...
module AutomaticTagAvailable : sig
  ...
  (** Get account available auto tags
      ...
      **PeerTube >= 6.2**
      @param account_name account name to get auto tag policies
  *)
  val get_api_v1_automatic_tags_accounts_by_account_name_available : account_name:string -> t -> unit -> T.t
...
module Actor : sig
  ...
  module T : sig
    ...
    *)
    val v : ?avatars:ActorImage.T.t list -> ?created_at:Ptime.t -> ?followers_count:int -> ?following_count:int -> ?host:string -> ?host_redundancy_allowed:bool option -> ?id:Id.T.t -> ?name:Username.T.t -> ?updated_at:Ptime.t -> ?url:string -> unit -> t
    ...
    val host_redundancy_allowed : t -> bool option option
...
module VideoPlaylist : sig
  ...
  *)
  val get_api_v1_video_playlists_by_playlist_id : playlist_id:string -> t -> unit -> T.t
end
...
module Video : sig
  ...
  module T : sig
    ...
    *)
    val v : ?account:AccountSummary.T.t -> ?aspect_ratio:float option -> ?blacklisted:bool option -> ?blacklisted_reason:string option -> ?category:VideoConstantNumberCategory.T.t -> ?channel:VideoChannelSummary.T.t -> ?comments:int -> ?created_at:Ptime.t -> ?dislikes:int -> ?duration:int -> ?embed_path:string -> ?id:Id.T.t -> ?is_live:bool -> ?is_local:bool -> ?language:VideoConstantStringLanguage.T.t -> ?licence:VideoConstantNumberLicence.T.t -> ?likes:int -> ?live_schedules:LiveSchedule.T.t list -> ?name:string -> ?nsfw:bool -> ?nsfw_flags:Nsfwflag.T.t -> ?nsfw_summary:string option -> ?originally_published_at:Ptime.t option -> ?preview_path:string -> ?privacy:VideoPrivacyConstant.T.t -> ?published_at:Ptime.t -> ?scheduled_update:VideoScheduled.Update.t -> ?short_uuid:ShortUuid.T.t -> ?state:VideoStateConstant.T.t -> ?thumbnail_path:string -> ?truncated_description:string option -> ?updated_at:Ptime.t -> ?user_history:Jsont.json option -> ?uuid:Uuidv4.T.t -> ?views:int -> ?wait_transcoding:bool option -> unit -> t

    val account : t -> AccountSummary.T.t option

    (** **PeerTube >= 6.1** Aspect ratio of the video stream *)
    val aspect_ratio : t -> float option option

    val blacklisted : t -> bool option option

    val blacklisted_reason : t -> string option option
     ...
     *)
    val truncated_description : t -> string option option

    (** last time the video's metadata was modified *)
    val updated_at : t -> Ptime.t option

    val user_history : t -> Jsont.json option option
    ...
    val wait_transcoding : t -> bool option option
...
module VideoRating : sig
  ...
  *)
  val get_api_v1_accounts_by_name_ratings : name:string -> ?start:string -> ?count:string -> ?sort:string -> ?rating:string -> t -> unit -> T.t list
end
...
module VideoImportsList : sig
  ...
  *)
  val get_api_v1_users_me_videos_imports : ?start:string -> ?count:string -> ?sort:string -> ?include_collaborations:string -> ?video_id:string -> ?target_url:string -> ?video_channel_sync_id:string -> ?search:string -> t -> unit -> T.t
end
...
module Notification : sig
  ...
  module T : sig
    ...
    (** Construct a value *)
    val v : ?account:Actor.Info.t -> ?actor_follow:Jsont.json option -> ?comment:Jsont.json option -> ?created_at:Ptime.t -> ?id:Id.T.t -> ?read:bool -> ?type_:Type.t -> ?updated_at:Ptime.t -> ?video:Video.Info.t option -> ?video_abuse:Jsont.json option -> ?video_blacklist:Jsont.json option -> ?video_import:Jsont.json option -> unit -> t

    val account : t -> Actor.Info.t option

    val actor_follow : t -> Jsont.json option option

    val comment : t -> Jsont.json option option
    ...
    val video : t -> Video.Info.t option option

    val video_abuse : t -> Jsont.json option option

    val video_blacklist : t -> Jsont.json option option

    val video_import : t -> Jsont.json option option
...
module Account : sig
  module T : sig
    ...
    *)
    val v : ?avatars:ActorImage.T.t list -> ?created_at:Ptime.t -> ?followers_count:int -> ?following_count:int -> ?host:string -> ?host_redundancy_allowed:bool option -> ?id:Id.T.t -> ?name:Username.T.t -> ?updated_at:Ptime.t -> ?url:string -> ?user_id:Jsont.json -> ?display_name:string -> ?description:string option -> unit -> t
...
module VideoComment : sig
  module T : sig
    ...
    *)
    val v : ?is_deleted:bool -> ?account:Account.T.t -> ?created_at:Ptime.t -> ?deleted_at:Ptime.t option -> ?held_for_review:bool -> ?id:Id.T.t -> ?in_reply_to_comment_id:Id.T.t -> ?text:string -> ?thread_id:Id.T.t -> ?total_replies:int -> ?total_replies_from_video_author:int -> ?updated_at:Ptime.t -> ?url:string -> ?video_id:Jsont.json -> unit -> t

    val account : t -> Account.T.t option

    val created_at : t -> Ptime.t option

    val deleted_at : t -> Ptime.t option option
...
module VideoCommentThreadTree : sig
  ...
  (** Get a thread
      ...
      @param x_peertube_video_password Required on password protected video
  *)
  val get_api_v1_videos_by_id_comment_threads_by_thread_id : id:string -> thread_id:string -> ?x_peertube_video_password:string -> t -> unit -> T.t
end
...
module CommentThreadPost : sig
  ...
  (** Create a thread
      @param id The object id, uuid or short uuid
  *)
  val post_api_v1_videos_by_id_comment_threads : id:string -> ?body:Jsont.json -> t -> unit -> Response.t
  ...
  (** Reply to a thread of a video
      ...
      @param x_peertube_video_password Required on password protected video
  *)
  val post_api_v1_videos_by_id_comments_by_comment_id : id:string -> comment_id:string -> ?x_peertube_video_password:string -> ?body:Jsont.json -> t -> unit -> Response.t
end
...
module CommentThread : sig
  ...
  (** List threads of a video
      ...
      @param x_peertube_video_password Required on password protected video
  *)
  val get_api_v1_videos_by_id_comment_threads : id:string -> ?start:string -> ?count:string -> ?sort:string -> ?x_peertube_video_password:string -> t -> unit -> Response.t
end
...
module VideoChannel : sig
  ...
  module T : sig
    ...
    *)
    val v : ?avatars:ActorImage.T.t list -> ?created_at:Ptime.t -> ?followers_count:int -> ?following_count:int -> ?host:string -> ?host_redundancy_allowed:bool option -> ?id:Id.T.t -> ?name:Username.T.t -> ?url:string -> ?display_name:string -> ?description:string option -> ?support:string option -> ?is_local:bool -> ?updated_at:Ptime.t -> ?banners:ActorImage.T.t list -> ?owner_account:Account.T.t -> unit -> t
    ...
    val support : t -> string option option
  ...
  *)
  val get_api_v1_users_me_subscriptions_by_subscription_handle : subscription_handle:string -> t -> unit -> T.t
...
module VideoDetails : sig
  module T : sig
    ...
    *)
    val v : ?aspect_ratio:float option -> ?blacklisted:bool option -> ?blacklisted_reason:string option -> ?category:VideoConstantNumberCategory.T.t -> ?comments:int -> ?created_at:Ptime.t -> ?dislikes:int -> ?duration:int -> ?embed_path:string -> ?id:Id.T.t -> ?is_live:bool -> ?is_local:bool -> ?language:VideoConstantStringLanguage.T.t -> ?licence:VideoConstantNumberLicence.T.t -> ?likes:int -> ?live_schedules:LiveSchedule.T.t list -> ?name:string -> ?nsfw:bool -> ?nsfw_flags:Nsfwflag.T.t -> ?nsfw_summary:string option -> ?originally_published_at:Ptime.t option -> ?preview_path:string -> ?privacy:VideoPrivacyConstant.T.t -> ?published_at:Ptime.t -> ?scheduled_update:VideoScheduled.Update.t -> ?short_uuid:ShortUuid.T.t -> ?state:VideoStateConstant.T.t -> ?thumbnail_path:string -> ?truncated_description:string option -> ?updated_at:Ptime.t -> ?user_history:Jsont.json option -> ?uuid:Uuidv4.T.t -> ?views:int -> ?wait_transcoding:bool option -> ?viewers:int -> ?description:string option -> ?support:string option -> ?channel:VideoChannel.T.t -> ?account:Account.T.t -> ?tags:string list -> ?comments_policy:VideoCommentsPolicyConstant.T.t -> ?download_enabled:bool -> ?input_file_updated_at:Ptime.t option -> ?tracker_urls:string list -> ?files:VideoFile.T.t list -> ?streaming_playlists:VideoStreamingPlaylists.T.t list -> unit -> t
    ...
    val input_file_updated_at : t -> Ptime.t option option
  ...
  (** Get a video
      ...
      @param x_peertube_video_password Required on password protected video
  *)
  val get_video : id:string -> ?x_peertube_video_password:string -> t -> unit -> T.t
end
...
module VideoChannelSync : sig
  ...
  module T : sig
    ...
    (** Construct a value *)
    val v : ?channel:VideoChannel.T.t -> ?created_at:Ptime.t -> ?external_channel_url:string -> ?id:Id.T.t -> ?last_sync_at:Ptime.t option -> ?state:Jsont.json -> unit -> t
    ...
    val last_sync_at : t -> Ptime.t option option
...
module VideoChannelSyncList : sig
  ...
  (** List the synchronizations of video channels of an account
      ...
      @param include_collaborations **PeerTube >= 8.0** Include objects from collaborated channels
  *)
  val get_api_v1_accounts_by_name_video_channel_syncs : name:string -> ?start:string -> ?count:string -> ?sort:string -> ?include_collaborations:string -> t -> unit -> T.t
end
...
module Client : sig
  ...
  *)
  val put_api_v1_abuses_by_abuse_id : abuse_id:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Delete an abuse
      @param abuse_id Abuse id
  *)
  val delete_api_v1_abuses_by_abuse_id : abuse_id:string -> t -> unit -> unit

  (** List messages of an abuse
      @param abuse_id Abuse id
  *)
  val get_api_v1_abuses_by_abuse_id_messages : abuse_id:string -> t -> unit -> Jsont.json

  (** Add message to an abuse
      @param abuse_id Abuse id
  *)
  val post_api_v1_abuses_by_abuse_id_messages : abuse_id:string -> body:Jsont.json -> t -> unit -> unit

  (** Delete an abuse message
      @param abuse_id Abuse id
      @param abuse_message_id Abuse message id
  *)
  val delete_api_v1_abuses_by_abuse_id_messages_by_abuse_message_id : abuse_id:string -> abuse_message_id:string -> t -> unit -> unit
  ...
  *)
  val get_api_v1_accounts_by_name_video_playlists : name:string -> ?start:string -> ?count:string -> ?sort:string -> ?search:string -> ?playlist_type:string -> ?include_collaborations:string -> ?channel_name_one_of:string -> t -> unit -> Jsont.json
  ...
  *)
  val put_api_v1_automatic_tags_policies_accounts_by_account_name_comments : account_name:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  val update_client_language : ?body:Jsont.json -> t -> unit -> unit

  (** Set instance runtime configuration *)
  val put_custom_config : t -> unit -> unit

  (** Delete instance runtime configuration *)
  val del_custom_config : t -> unit -> unit

  (** Delete instance avatar *)
  val delete_api_v1_config_instance_avatar : t -> unit -> unit

  (** Update instance avatar *)
  val post_api_v1_config_instance_avatar_pick : ?body:Fetch.Form.part list -> t -> unit -> unit

  (** Delete instance banner *)
  val delete_api_v1_config_instance_banner : t -> unit -> unit

  (** Update instance banner *)
  val post_api_v1_config_instance_banner_pick : ?body:Fetch.Form.part list -> t -> unit -> unit

  (** Delete instance logo *)
  val delete_api_v1_config_instance_logo_logo_type : t -> unit -> unit

  (** Update instance logo *)
  val post_api_v1_config_instance_logo_logo_type_pick : ?body:Fetch.Form.part list -> t -> unit -> unit

  (** Set instance custom homepage *)
  val put_api_v1_custom_pages_homepage_instance : ?body:Jsont.json -> t -> unit -> unit

  (** Pause job queue *)
  val post_api_v1_jobs_pause : t -> unit -> unit

  (** Resume job queue *)
  val post_api_v1_jobs_resume : t -> unit -> unit
  ...
  *)
  ...
  val post_api_v1_metrics_playback : ?body:PlaybackMetric.Create.t -> t -> unit -> unit

  (** Install a plugin *)
  val add_plugin : ?body:Jsont.json -> t -> unit -> unit

  (** Uninstall a plugin *)
  val uninstall_plugin : ?body:Jsont.json -> t -> unit -> unit

  (** Update a plugin *)
  val update_plugin : ?body:Jsont.json -> t -> unit -> unit

  (** Get a plugin's public settings
      @param npm_name name of the plugin/theme on npmjs.com or in its package.json
  *)
  val get_api_v1_plugins_by_npm_name_public_settings : npm_name:string -> t -> unit -> Jsont.json

  (** Get a plugin's registered settings
      @param npm_name name of the plugin/theme on npmjs.com or in its package.json
  *)
  val get_api_v1_plugins_by_npm_name_registered_settings : npm_name:string -> t -> unit -> Jsont.json

  (** Set a plugin's settings
      @param npm_name name of the plugin/theme on npmjs.com or in its package.json
  *)
  val put_api_v1_plugins_by_npm_name_settings : npm_name:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  ...
  val delete_api_v1_runners_jobs_by_job_uuid : job_uuid:string -> t -> unit -> unit

  (** Abort job

      API used by PeerTube runners *)
  val post_api_v1_runners_jobs_by_job_uuid_abort : job_uuid:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Accept job

      API used by PeerTube runners *)
  val post_api_v1_runners_jobs_by_job_uuid_accept : job_uuid:string -> ?body:Jsont.json -> t -> unit -> Jsont.json

  (** Cancel a job *)
  val get_api_v1_runners_jobs_by_job_uuid_cancel : job_uuid:string -> t -> unit -> unit

  (** Post job error

      API used by PeerTube runners *)
  val post_api_v1_runners_jobs_by_job_uuid_error : job_uuid:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Post job success

      API used by PeerTube runners *)
  val post_api_v1_runners_jobs_by_job_uuid_success : job_uuid:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Update job

      API used by PeerTube runners *)
  val post_api_v1_runners_jobs_by_job_uuid_update : job_uuid:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  ...
  val post_api_v1_runners_registration_tokens_generate : t -> unit -> unit

  (** Remove registration token

      Remove a registration token. Runners that used this token for their registration are automatically removed. *)
  val delete_api_v1_runners_registration_tokens_by_registration_token_id : registration_token_id:string -> t -> unit -> unit

  (** Unregister a runner

      API used by PeerTube runners *)
  val post_api_v1_runners_unregister : ?body:Jsont.json -> t -> unit -> unit

  (** Delete a runner *)
  val delete_api_v1_runners_by_runner_id : runner_id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  ...
  val get_instance_audit_logs : t -> unit -> string list
  ...
  (** List account blocks
      ...
      @param sort Sort column
  *)
  val get_api_v1_server_blocklist_accounts : ?start:string -> ?count:string -> ?sort:string -> t -> unit -> unit

  (** Block an account *)
  val post_api_v1_server_blocklist_accounts : ?body:Jsont.json -> t -> unit -> unit

  (** Unblock an account by its handle
      @param account_name account to unblock, in the form `username@domain`
  *)
  val delete_api_v1_server_blocklist_accounts_by_account_name : account_name:string -> t -> unit -> unit
  ...
  (** List server blocks
      ...
      @param sort Sort column
  *)
  val get_api_v1_server_blocklist_servers : ?start:string -> ?count:string -> ?sort:string -> t -> unit -> unit

  (** Block a server *)
  val post_api_v1_server_blocklist_servers : ?body:Jsont.json -> t -> unit -> unit

  (** Unblock a server by its domain
      @param host server domain to unblock
  *)
  val delete_api_v1_server_blocklist_servers_by_host : host:string -> t -> unit -> unit
  ...
  *)
  val delete_api_v1_server_followers_by_handle : handle:string -> t -> unit -> unit

  (** Accept a pending follower to your server
      @param handle The remote actor handle to remove from your followers
  *)
  val post_api_v1_server_followers_by_handle_accept : handle:string -> t -> unit -> unit

  (** Reject a pending follower to your server
      @param handle The remote actor handle to remove from your followers
  *)
  val post_api_v1_server_followers_by_handle_reject : handle:string -> t -> unit -> unit
  ...
  *)
  ...
  val post_api_v1_server_following : ?body:Jsont.json -> t -> unit -> unit

  (** Unfollow an actor (PeerTube instance, channel or account)
      @param host_or_handle The hostOrHandle to unfollow
  *)
  val delete_api_v1_server_following_by_host_or_handle : host_or_handle:string -> t -> unit -> unit

  (** Get instance logs *)
  val get_instance_logs : t -> unit -> string list

  (** Send client log *)
  val send_client_log : ?body:SendClientLog.T.t -> t -> unit -> unit

  (** Mirror a video *)
  val put_mirrored_video : ?body:Jsont.json -> t -> unit -> unit

  (** Delete a mirror done on a video
      @param redundancy_id id of an existing redundancy on a video
  *)
  val del_mirrored_video : redundancy_id:string -> t -> unit -> unit

  (** Update a server redundancy policy
      @param host server domain to mirror
  *)
  val put_api_v1_server_redundancy_by_host : host:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Ask to reset password

      An email containing a reset password link *)
  val post_api_v1_users_ask_reset_password : ?body:Jsont.json -> t -> unit -> unit

  (** Resend user verification link *)
  val resend_email_to_verify_user : ?body:Jsont.json -> t -> unit -> unit

  (** Update my user information *)
  val put_user_info : body:UpdateMe.T.t -> t -> unit -> unit
  ...
  *)
  ...
  (** Delete my avatar *)
  val delete_api_v1_users_me_avatar : t -> unit -> unit

  (** Update my user avatar *)
  val post_api_v1_users_me_avatar_pick : ?body:Fetch.Form.part list -> t -> unit -> Jsont.json

  (** Clear video history *)
  val post_api_v1_users_me_history_videos_remove : ?body:Fetch.Form.part list -> t -> unit -> unit

  (** Delete history element *)
  val delete_api_v1_users_me_history_videos_by_video_id : video_id:string -> t -> unit -> unit

  (** Mark feature info as read

      **PeerTube >= v8.0.0 *)
  val post_api_v1_users_me_new_feature_info_read : ?body:Jsont.json -> t -> unit -> unit

  (** Update my notification settings *)
  val put_api_v1_users_me_notification_settings : ?body:UserNotificationSettings.T.t -> t -> unit -> unit

  (** Mark notifications as read by their id *)
  val post_api_v1_users_me_notifications_read : ?body:Jsont.json -> t -> unit -> unit

  (** Mark all my notification as read *)
  val post_api_v1_users_me_notifications_read_all : t -> unit -> unit

  (** Add subscription to my user *)
  val post_api_v1_users_me_subscriptions : ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  ...
  (** Delete subscription of my user
      @param subscription_handle The subscription handle
  *)
  val delete_api_v1_users_me_subscriptions_by_subscription_handle : subscription_handle:string -> t -> unit -> unit
  ...
  *)
  ...
  val register_user : body:RegisterUser.T.t -> t -> unit -> unit
  ...
  *)
  ...
  val resend_email_to_verify_registration : ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  val delete_registration : registration_id:string -> t -> unit -> unit

  (** Accept registration
      @param registration_id Registration ID
  *)
  val accept_registration : registration_id:string -> ?body:UserRegistrationAcceptOrReject.T.t -> t -> unit -> unit

  (** Reject registration
      @param registration_id Registration ID
  *)
  val reject_registration : registration_id:string -> ?body:UserRegistrationAcceptOrReject.T.t -> t -> unit -> unit
  ...
  containing a secret.
      ...
      @param registration_id Registration ID
  *)
  val verify_registration_email : registration_id:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Logout

      Revokes your access token and its associated refresh token, destroying your current session. *)
  val revoke_oauth_token : t -> unit -> unit
  ...
  *)
  val get_oauth_token : ?x_peertube_otp:string -> ?body:(string * string) list -> t -> unit -> Jsont.json
  ...
  *)
  ...
  (** Update a user
      @param id Entity id
  *)
  val put_user : id:string -> body:UpdateUser.T.t -> t -> unit -> unit

  (** Delete a user
      @param id Entity id
  *)
  val del_user : id:string -> t -> unit -> unit

  (** Reset password
      @param id Entity id
  *)
  val post_api_v1_users_by_id_reset_password : id:string -> ?body:Jsont.json -> t -> unit -> unit

  (** List token sessions
      @param id Entity id
  *)
  val get_api_v1_users_by_id_token_sessions : id:string -> t -> unit -> Jsont.json

  (** List token sessions
      @param id Entity id
      @param token_session_id Token session Id
  *)
  val get_api_v1_users_by_id_token_sessions_by_token_session_id_revoke : id:string -> token_session_id:string -> t -> unit -> unit
  ...
  (** Confirm two factor auth
      ...
      @param id Entity id
  *)
  val confirm_two_factor_request : id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  (** Disable two factor auth
      ...
      @param id Entity id
  *)
  val disable_two_factor : id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  This endpoint can also be used to verify a new email set in the user account.
      ...
      @param id Entity id
  *)
  val verify_user : id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  ...
  (** Delete a user export
      ...
      **PeerTube >= 6.1**
      ...
      @param id Entity id
  *)
  val delete_user_export : user_id:string -> id:string -> t -> unit -> unit
  ...
  *)
  val user_import_resumable_init : user_id:string -> x_upload_content_length:string -> x_upload_content_type:string -> ?body:UserImportResumable.T.t -> t -> unit -> unit
  ...
  *)
  val user_import_resumable : user_id:string -> upload_id:string -> content_range:string -> content_length:string -> ?body:Fetch.body -> t -> unit -> unit
  ...
  *)
  val user_import_resumable_cancel : user_id:string -> upload_id:string -> content_length:string -> t -> unit -> unit
  ...
  *)
  val del_video_channel_sync : channel_sync_id:string -> t -> unit -> unit

  (** Triggers the channel synchronization job, fetching all the videos from the remote channel
      @param channel_sync_id Channel Sync id
  *)
  val trigger_video_channel_sync : channel_sync_id:string -> t -> unit -> unit
  ...
  (** Update a video channel
      @param channel_handle The video channel handle
  *)
  val put_video_channel : channel_handle:string -> ?body:VideoChannel.Update.t -> t -> unit -> unit

  (** Delete a video channel
      @param channel_handle The video channel handle
  *)
  val del_video_channel : channel_handle:string -> t -> unit -> unit

  (** Delete channel avatar
      @param channel_handle The video channel handle
  *)
  val delete_api_v1_video_channels_by_channel_handle_avatar : channel_handle:string -> t -> unit -> unit

  (** Update channel avatar
      @param channel_handle The video channel handle
  *)
  val post_api_v1_video_channels_by_channel_handle_avatar_pick : channel_handle:string -> ?body:Fetch.Form.part list -> t -> unit -> Jsont.json

  (** Delete channel banner
      @param channel_handle The video channel handle
  *)
  val delete_api_v1_video_channels_by_channel_handle_banner : channel_handle:string -> t -> unit -> unit

  (** Update channel banner
      @param channel_handle The video channel handle
  *)
  val post_api_v1_video_channels_by_channel_handle_banner_pick : channel_handle:string -> ?body:Fetch.Form.part list -> t -> unit -> Jsont.json
  ...
  *)
  val remove_video_channel_collaborator : channel_handle:string -> collaborator_id:string -> t -> unit -> unit
  ...
  (** Accept a collaboration invitation
      ...
      **PeerTube >= 8.0**
      ...
      @param collaborator_id The collaborator id
  *)
  val accept_video_channel_collaborator : channel_handle:string -> collaborator_id:string -> t -> unit -> unit
  ...
  (** Reject a collaboration invitation
      ...
      **PeerTube >= 8.0**
      ...
      @param collaborator_id The collaborator id
  *)
  val reject_video_channel_collaborator : channel_handle:string -> collaborator_id:string -> t -> unit -> unit
  ...
  *)
  ...
  (** Import videos in channel
      ...
      @param channel_handle The video channel handle
  *)
  val post_api_v1_video_channels_by_channel_handle_import_videos : channel_handle:string -> ?body:ImportVideosInChannel.Create.t -> t -> unit -> unit
  ...
  (** List playlists of a channel
      ...
      @param sort Sort column
  *)
  val get_api_v1_video_channels_by_channel_handle_video_playlists : channel_handle:string -> ?start:string -> ?count:string -> ?sort:string -> ?playlist_type:string -> t -> unit -> Jsont.json

  (** Reorder channel playlists
      @param channel_handle The video channel handle
  *)
  val reorder_video_playlists_of_channel : channel_handle:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  ...
  val add_playlist : ?body:Fetch.Form.part list -> t -> unit -> Jsont.json

  (** List available playlist privacy policies *)
  val get_playlist_privacy_policies : t -> unit -> string list
  ...
  (** Update a video playlist
      ...
      @param playlist_id Playlist id
  *)
  val put_api_v1_video_playlists_by_playlist_id : playlist_id:string -> ?body:Fetch.Form.part list -> t -> unit -> unit

  (** Delete a video playlist
      @param playlist_id Playlist id
  *)
  val delete_api_v1_video_playlists_by_playlist_id : playlist_id:string -> t -> unit -> unit
  ...
  *)
  ...
  (** Reorder playlist elements
      @param playlist_id Playlist id
  *)
  val reorder_video_playlist : playlist_id:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Update a playlist element
      @param playlist_id Playlist id
      @param playlist_element_id Playlist element id
  *)
  val put_video_playlist_video : playlist_id:string -> playlist_element_id:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Delete an element from a playlist
      @param playlist_id Playlist id
      @param playlist_element_id Playlist element id
  *)
  val del_video_playlist_video : playlist_id:string -> playlist_element_id:string -> t -> unit -> unit
  ...
  *)
  ...
  val get_categories : t -> unit -> string list
  ...
  *)
  ...
  (** Delete video import
      ...
      @param id Entity id
  *)
  val delete_api_v1_videos_imports_by_id : id:string -> t -> unit -> unit
  ...
  (** Cancel video import
      ...
      @param id Entity id
  *)
  val post_api_v1_videos_imports_by_id_cancel : id:string -> t -> unit -> unit
  ...
  (** Retry video import
      ...
      **PeerTube >= 8.0** Retry a pending video import
      @param id Entity id
  *)
  val post_api_v1_videos_imports_by_id_retry : id:string -> t -> unit -> unit

  (** List available video languages *)
  val get_languages : t -> unit -> string list

  (** List available video licences *)
  val get_licences : t -> unit -> string list

  (** Update information about a live
      @param id The object id, uuid or short uuid
  *)
  val update_live_id : id:string -> ?body:LiveVideo.Update.t -> t -> unit -> unit
  ...
  (** List live sessions
      ...
      @param sort Sort column
  *)
  val get_api_v1_videos_live_by_id_sessions : id:string -> ?sort:string -> t -> unit -> Jsont.json

  (** List video ownership changes *)
  val get_api_v1_videos_ownership : t -> unit -> unit

  (** Accept ownership change request
      @param id The object id, uuid or short uuid
  *)
  val post_api_v1_videos_ownership_by_id_accept : id:string -> t -> unit -> unit

  (** Refuse ownership change request
      @param id The object id, uuid or short uuid
  *)
  val post_api_v1_videos_ownership_by_id_refuse : id:string -> t -> unit -> unit

  (** List available video privacy policies *)
  val get_video_privacy_policies : t -> unit -> string list
  ...
  (** Initialize the resumable upload of a video
      ...
      @param x_upload_content_type MIME type of the file that you are uploading. Depending on your instance settings, acceptable values might vary.
  *)
  val upload_resumable_init : x_upload_content_length:string -> x_upload_content_type:string -> ?body:VideoUploadRequestResumable.T.t -> t -> unit -> unit
  ...
  *)
  val upload_resumable_cancel : upload_id:string -> content_length:string -> t -> unit -> unit

  (** Update a video
      @param id The object id, uuid or short uuid
  *)
  val put_video : id:string -> ?body:Fetch.Form.part list -> t -> unit -> unit

  (** Delete a video
      @param id The object id, uuid or short uuid
  *)
  val del_video : id:string -> t -> unit -> unit

  (** Block a video
      @param id The object id, uuid or short uuid
  *)
  val add_video_block : id:string -> t -> unit -> unit

  (** Unblock a video by its id
      @param id The object id, uuid or short uuid
  *)
  val del_video_block : id:string -> t -> unit -> unit

  (** List captions of a video
      @param id The object id, uuid or short uuid
      @param x_peertube_video_password Required on password protected video
  *)
  val get_video_captions : id:string -> ?x_peertube_video_password:string -> t -> unit -> Jsont.json
  ...
  (** Generate a video caption
      ...
      **PeerTube >= 6.2** This feature has to be enabled by the administrator
      @param id The object id, uuid or short uuid
  *)
  val generate_video_caption : id:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Add or replace a video caption
      @param id The object id, uuid or short uuid
      @param caption_language The caption language
  *)
  val add_video_caption : id:string -> caption_language:string -> ?body:Fetch.Form.part list -> t -> unit -> unit

  (** Delete a video caption
      @param id The object id, uuid or short uuid
      @param caption_language The caption language
  *)
  val del_video_caption : id:string -> caption_language:string -> t -> unit -> unit
  ...
  (** Replace video chapters
      ...
      **PeerTube >= 6.0**
      @param id The object id, uuid or short uuid
  *)
  val replace_video_chapters : id:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Delete a comment or a reply
      @param id The object id, uuid or short uuid
      @param comment_id The comment id
  *)
  val delete_api_v1_videos_by_id_comments_by_comment_id : id:string -> comment_id:string -> t -> unit -> unit
  ...
  (** Approve a comment
      ...
      **PeerTube >= 6.2** Approve a comment that requires a review
      ...
      @param comment_id The comment id
  *)
  val post_api_v1_videos_by_id_comments_by_comment_id_approve : id:string -> comment_id:string -> t -> unit -> unit

  (** Get complete video description
      @param id The object id, uuid or short uuid
      @param x_peertube_video_password Required on password protected video
  *)
  val get_video_desc : id:string -> ?x_peertube_video_password:string -> t -> unit -> string option

  (** Request ownership change
      @param id The object id, uuid or short uuid
  *)
  val post_api_v1_videos_by_id_give_ownership : id:string -> body:Jsont.json -> t -> unit -> unit

  (** Delete video HLS files
      @param id The object id, uuid or short uuid
  *)
  val del_video_hls : id:string -> t -> unit -> unit
  ...
  (** List video passwords
      ...
      **PeerTube >= 6.0**
      ...
      @param sort Sort column
  *)
  val list_video_passwords : id:string -> ?start:string -> ?count:string -> ?sort:string -> t -> unit -> unit
  ...
  (** Add a video password
      ...
      **PeerTube >= 8.0**
      @param id The object id, uuid or short uuid
  *)
  val add_video_password : id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  (** Update video passwords
      ...
      **PeerTube >= 6.0**
      @param id The object id, uuid or short uuid
  *)
  val update_video_password_list : id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  val remove_video_password : id:string -> video_password_id:string -> t -> unit -> unit

  (** Like/dislike a video
      @param id The object id, uuid or short uuid
      @param x_peertube_video_password Required on password protected video
  *)
  val put_api_v1_videos_by_id_rate : id:string -> ?x_peertube_video_password:string -> ?body:Jsont.json -> t -> unit -> unit

  (** Delete video source file
      @param id The object id, uuid or short uuid
  *)
  val delete_video_source_file : id:string -> t -> unit -> unit
  ...
  (** Initialize the resumable replacement of a video
      ...
      **PeerTube >= 6.0** Uses [a resumable protocol](https://github.com/kukhariev/node-uploadx/blob/master/proto.md) to initialize the replacement of a video
      ...
      @param x_upload_content_type MIME type of the file that you are uploading. Depending on your instance settings, acceptable values might vary.
  *)
  val replace_video_source_resumable_init : id:string -> x_upload_content_length:string -> x_upload_content_type:string -> ?body:VideoReplaceSourceRequestResumable.T.t -> t -> unit -> unit
  ...
  *)
  val replace_video_source_resumable : id:string -> upload_id:string -> content_range:string -> content_length:string -> ?body:Fetch.body -> t -> unit -> unit
  ...
  *)
  val replace_video_source_resumable_cancel : id:string -> upload_id:string -> content_length:string -> t -> unit -> unit
  ...
  *)
  ...
  (** Create a studio task
      ...
      @param id The object id, uuid or short uuid
  *)
  val post_api_v1_videos_by_id_studio_edit : id:string -> body:Fetch.Form.part list -> t -> unit -> unit

  (** Create a transcoding job
      @param id The object id, uuid or short uuid
  *)
  val create_video_transcoding : id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  (** Notify user is watching a video
      ...
      @param id The object id, uuid or short uuid
  *)
  val add_view : id:string -> body:UserViewingVideo.T.t -> t -> unit -> unit
  ...
  (** Delete video Web Video files
      ...
      **PeerTube >= 6.0**
      @param id The object id, uuid or short uuid
  *)
  val del_video_web_videos : id:string -> t -> unit -> unit
  ...
  *)
  val get_api_v1_watched_words_accounts_by_account_name_lists : account_name:string -> t -> unit -> Jsont.json

  (** Add account watched words

      **PeerTube >= 6.2** *)
  val post_api_v1_watched_words_accounts_by_account_name_lists : account_name:string -> ?body:Jsont.json -> t -> unit -> Jsont.json
  ...
  *)
  val put_api_v1_watched_words_accounts_by_account_name_lists_by_list_id : account_name:string -> list_id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  *)
  val delete_api_v1_watched_words_accounts_by_account_name_lists_by_list_id : account_name:string -> list_id:string -> t -> unit -> unit
  ...
  (** Update server watched words
      ...
      **PeerTube >= 6.2**
      @param list_id list of watched words to update
  *)
  val put_api_v1_watched_words_server_lists_by_list_id : list_id:string -> ?body:Jsont.json -> t -> unit -> unit
  ...
  (** Delete server watched words
      ...
      **PeerTube >= 6.2**
      @param list_id list of watched words to delete
  *)
  val delete_api_v1_watched_words_server_lists_by_list_id : list_id:string -> t -> unit -> unit
  ...
  *)
  val get_download_videos_generate_by_video_id : video_id:string -> video_file_ids:string -> ?video_file_token:string -> t -> unit -> unit

  (** Videos podcast feed
      @param video_channel_id Limit listing to a specific video channel
  *)
  val get_videos_podcast_feed : video_channel_id:string -> t -> unit -> unit
  ...
  *)
  val get_static_streaming_playlists_hls_private__by_filename : filename:string -> ?video_file_token:string -> ?reinject_video_file_token:string -> t -> unit -> unit

  (** Get public HLS video file
      @param filename Filename
  *)
  val get_static_streaming_playlists_hls_by_filename : filename:string -> t -> unit -> unit
  ...
  (** Get private Web Video file
      ...
      **PeerTube >= 6.0**
      ...
      @param video_file_token Video file token [generated](#operation/requestVideoToken) by PeerTube so you don't need to provide an OAuth token in the request header.
  *)
  val get_static_web_videos_private__by_filename : filename:string -> ?video_file_token:string -> t -> unit -> unit
  ...
  (** Get public Web Video file
      ...
      **PeerTube >= 6.0**
      @param filename Filename
  *)
  val get_static_web_videos_by_filename : filename:string -> t -> unit -> unit
end
...
module VideoChannelList : sig
  ...
  (** List video channels of an account
      ...
      @param include_collaborations **PeerTube >= 8.0** Include objects from collaborated channels
  *)
  val get_api_v1_accounts_by_name_video_channels : name:string -> ?with_stats:string -> ?start:string -> ?count:string -> ?search:string -> ?sort:string -> ?include_collaborations:string -> t -> unit -> T.t
...
module User : sig
  ...
  *)
  val get_users : ?search:string -> ?blocked:string -> ?start:string -> ?count:string -> ?sort:string -> t -> unit -> T.t list

  (** Get my user information *)
  val get_user_info : t -> unit -> T.t list
end
