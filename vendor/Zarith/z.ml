...
external to_int32_unsigned: t -> int32 @@ portable = "ml_z_to_int32_unsigned"
external to_int64_unsigned: t -> int64 @@ portable = "ml_z_to_int64_unsigned"
external to_nativeint_unsigned: t -> nativeint @@ portable = "ml_z_to_nativeint_unsigned"
...
external fits_int32_unsigned: t -> bool @@ portable = "ml_z_fits_int32_unsigned" [@@noalloc]
external fits_int64_unsigned: t -> bool @@ portable = "ml_z_fits_int64_unsigned" [@@noalloc]
external fits_nativeint_unsigned: t -> bool @@ portable = "ml_z_fits_nativeint_unsigned" [@@noalloc]
...
external c_divisible: t -> t -> bool @@ portable = "ml_z_divisible"
...
external c_extract_small: t -> int -> int -> t @@ portable
  = "ml_z_extract_small" [@@noalloc]
external c_extract: t -> int -> int -> t @@ portable = "ml_z_extract"

let[@portable] extract_internal x o l =
  if is_small_int x then
    (* Fast path *)
