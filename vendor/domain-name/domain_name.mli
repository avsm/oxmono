...
val of_string : string -> ([ `raw ] t, [> `Msg of string ]) result @@ portable
...
val host_exn : 'a t -> [ `host ] t @@ portable
...
val is_subdomain : subdomain:'a t -> domain:'b t -> bool @@ portable
...
val get_label : ?rev:bool -> 'a t -> int ->
  (string, [> `Msg of string ]) result @@ portable
...
val get_label_exn : ?rev:bool -> 'a t -> int -> string @@ portable
...
val equal : ?case_sensitive:bool -> 'a t -> 'b t -> bool @@ portable
...
val compare : 'a t -> 'b t -> int @@ portable
...
val equal_label : ?case_sensitive:bool -> string -> string -> bool @@ portable
...
val compare_label : string -> string -> int @@ portable
...
val to_strings : ?trailing:bool -> 'a t -> string list @@ portable
