...
module At : sig
  ...
  (** The type for attributes. An attribute is a pair of strings, so it
      crosses portability and contention. *)
...
module El : sig
  ...
  type html : immutable_data
  (** The type for HTML fragments. A fragment is built from strings, lists
      and {!At.t}, so it crosses portability and contention. A fragment is
      either:
      {ul
