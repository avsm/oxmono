...
external elapsed_ns : unit -> int64 @@ portable =
  "ocaml_mtime_clock_elapsed_ns"
external now_ns : unit -> int64 @@ portable = "ocaml_mtime_clock_now_ns"
external period_ns : unit -> int64 option @@ portable =
  "ocaml_mtime_clock_period_ns"
