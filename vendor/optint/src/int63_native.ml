...
external of_int : t -> t @@ portable = "%identity"
external to_int : t -> t @@ portable = "%identity"
...
external to_unsigned_int : t -> int @@ portable = "%identity"
external of_unsigned_int : int -> t @@ portable = "%identity"
...
external set_64 : bytes -> int -> int64 -> unit @@ portable = "%caml_bytes_set64u"
external get_64 : string -> int -> int64 @@ portable = "%caml_string_get64"
