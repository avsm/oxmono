...
external of_int32 : int32 -> t @@ portable = "%identity"
external of_unsigned_int32 : int32 -> t @@ portable = "%identity"
external to_int32 : t -> int32 @@ portable = "%identity"
external to_unsigned_int32 : t -> int32 @@ portable = "%identity"
...
external set_32 : bytes -> int -> int32 -> unit @@ portable = "%caml_bytes_set32u"
external get_32 : string -> int -> int32 @@ portable = "%caml_string_get32"
