...
val parse_record      : string ->
  ([ `Record of (Core.tls_hdr * string) * string
   | `Fragment of string
      ...
      | `Record_overflow of int ]) result @@ portable

val parse_handshake_frame : string -> (string option * string) @@ portable
...
val parse_dh_parameters        : string -> (Core.dh_parameters * string * string, [> `Decode of string ]) result @@ portable
val parse_ec_parameters        : string -> ([ `X25519 | `P256 | `P384 | `P521 ] * string * string * string, [> `Decode of string ]) result @@ portable
