...
val assemble_handshake : Core.tls_handshake -> string @@ portable

val assemble_client_hello_handshake : Core.client_hello -> string @@ portable

val assemble_message_hash : int -> string @@ portable
...
val assemble_client_dh_key_exchange : string -> string @@ portable

val assemble_client_ec_key_exchange : string -> string @@ portable
...
val assemble_certificates : string list -> string @@ portable

val assemble_certificates_1_3 : string -> string list -> string @@ portable
